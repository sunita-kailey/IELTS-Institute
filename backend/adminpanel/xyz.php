<?php
	...
	if(isset($_POST['flag'])&&$_POST['flag']=='update')
	{
		    ...
		    $sql_upd="update `faculty` set `name`='".$_POST['name']."',`position`='".$_POST['position']."',`qualification`='".$_POST['qualification']."',`experience`='".$_POST['experience']."',`expertise`='".$_POST['expertise']."',`experience`='".$_POST['experience']."',`pic`='".$pic_data."' where id=".$_POST['fclty_id'];
