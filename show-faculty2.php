...
?>	 
                     <div class="col-md-3 mt-3">
					      <div class="card">
						        <img src="backend/uploads/faculty_images/<?php echo $faculty['pic'];?>" width="300px" height="200px" alt="image">
								
								<div class="card-body">
								<h4 class="card-title"><?php echo $faculty['name'];?></h4>
								<h4 class="card-title"><?php echo $faculty['position'];?></h4>
								<p class="card-text">
								     <?php 
									 echo $faculty['qualification'];?><br>
									<?php echo $faculty['expertise'];?><br>
